...
pub mod stdout {
	...
	pub struct GrayscaleAsciiRenderer;

	impl Renderer for GrayscaleAsciiRenderer {
		fn begin_rendering(&mut self) {
			// Hide cursor
			print!("\x1b[?25l");
	...
	pub struct AnsiSpaceRenderer;

	impl Renderer for AnsiSpaceRenderer {
		fn begin_rendering(&mut self) {
			// Hide cursor
			print!("\x1b[?25l");
			// Return cursor to "home position"
...
pub mod kitty_graphics {
	...
	impl Renderer for EscapeRenderer {
		fn begin_rendering(&mut self) {
			// Hide cursor
			print!("\x1b[?25l");
			// Return cursor to "home position"
